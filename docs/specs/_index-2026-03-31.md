...
| 3 | Collaboration Organize Board | collaboration-board-2026-03-31.md | 4 | 24 |
| 4 | Campus Facility Access Booking | facility-booking-2026-03-31.md | 4 | 26 |
| 5 | Community Discussion Board | community-discussion-board-2026-03-31.md | 4 | 21 |
| 6 | Notifications (Email, LINE & Telegram) | notifications-2026-03-31.md | 5 | 35 |
...
- SF1: Collaboration Board & Discovery — two-sided board, tabs, type filter, search
- SF2: Posting (Requests & Offers) — 5 collaboration types, type-specific fields, creation form
...
- SF1: Venue Directory — browsable catalog, filtering, search, venue manager info
- SF2: Booking Request & Interest — create request, community interest, social proof threshold
- SF3: Venue Manager Dashboard — review requests, approve/reject, interest-based decisions
- SF4: My Bookings & Status — request lifecycle, confirmed bookings, cancellation policy
...
- SF4: Thread Interactions — upvotes, downvotes, bookmarks, best answer marking

### 6. Notifications (Email, LINE & Telegram)
- SF1: Notification Triggers — 13 event types mapped to channels (Email/LINE/Telegram)
...
- SF4: Telegram Notifications — Markdown messages, deeplinks, mock Telegram Bot API
- SF5: In-App Notification Center — bell icon, dropdown, full page, 3-channel preferences
